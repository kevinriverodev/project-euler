// Encontrar el mayor producto de un subconjunto de n digitos de thousandDigits.
...
function largestProductinaSeries(n) {
	...
	let count = 0, greatestProduct = 0, currentProduct = 0;

	while (count < thousandDigits.length) {
		currentProduct = thousandDigits
			.slice(count, count + n)
			.reduce((acum, num) => acum * num, 1);
